 ...
 * read/write a common data sources, you should use the built-in
...
/**
 * Read from a data sources.
 *
 * This function reads up to `maxnum` objects each of size `size` from the
 * data sources to the area pointed at by `ptr`. This function may read less
 ...
 * \param freesrc if non-zero, calls SDL_RWclose() on `source` before returning
