 ...
 *
 * When this texture is rendered, during the copy operation each sources color
 ...
 *
 * When this texture is rendered, during the copy operation the sources alpha
 ...
 *
 * \param texture the texture to update
 * \param alpha the sources alpha value multiplied into copy operations
 * \returns 0 on success or a negative error code on failure; call
 *          SDL_GetError() for more information.
 *
 * \since This function is available since SDL 2.0.0.
 ...
 *
 * \param renderer the rendering context
 * \param texture the sources texture
 * \param srcrect the sources SDL_Rect structure or NULL for the entire texture
 ...
 * \param texture The sources texture.
 * \param srcrect A pointer to the sources rectangle, or NULL for the entire
 *                texture.
...
/**
 * Copy a portion of the sources texture to the current rendering target, with
