...
*  can use two different sets of binaries, those compiled by the user from sources
...
*    "none" - do not load any library, useful if you compiled ANGLE from sources and included the compiler in your binaries.
*
*/
 ...
 *  The preprocessor define is left here for sources compatibility.
 */
 ...
 *  appears to be an audio sources or sink. This will add "devices" to the list
